/* ========================================================================
				TRANSLATOR FROM DIMACS TO A GRAPH COLOURING
...
//We extract the numbers of text file with regular expressions (explained in the report)
...
void translator(std::vector< std::vector<int> >& v){

	using namespace std;
	
	string line;
	ifstream file("file/exams.txt");
